...
def fit_one_epoch(student_model_train, student_model, teacher_model, yolo_loss, loss_history, eval_callback, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, Epoch, cuda, fp16, scaler, save_period, save_dir, local_rank=0):
    loss        = 0
    val_loss    = 0
    ...
    if local_rank == 0:
        ...
        eval_callback.on_epoch_end(epoch + 1, student_model_train)
        ...
        if len(loss_history.val_loss) <= 1 or (val_loss / epoch_step_val) <= min(loss_history.val_loss):
            ...
            torch.save(student_model.state_dict(), os.path.join(save_dir, "best_epoch_weights.pth"))
            
        torch.save(student_model.state_dict(), os.path.join(save_dir, "last_epoch_weights.pth"))